...
void WINAPI ServiceMain(DWORD argc, LPTSTR* argv)
{
    ...
    while (WaitForSingleObject(g_ServiceStopEvent, 0) != WAIT_OBJECT_0)
    {
        ...
        const char* exePath = "C:/Users/Magshimim/Documents/Magshimim/or-akiva-504-parentalcontrolp2p/ParentalControlFINAL_PROJ/x64/Debug/ParentalControlFINAL_PROJ.exe";

        // Single argument for the executable
        const char* argument = "Child";

        // Combine the path and argument into a single command line string
        std::string commandLine = std::string(exePath) + " " + argument;
